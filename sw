...
Title = "Warning"; -- the title (ofc)
Text = "WalkSpeed too high!"; -- body, 
...
hi.Name = "Sound"
hi.SoundId = "http://www.roblox.com/asset/?id=261072074"
hi.Volume = 2
hi.Looped = false
hi.archivable = false
...
tab1:Button("Auto Equip Mega VIP [Requires 6 Wins]", "This function alaways works.", function()
	...
	-- -11, 265, 61
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-11, 265, 61)

	wait(1)
	-- 11, 265, 79
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(11, 265, 79)
	   


	wait(1)
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(0, 268, 0)
...
tab3:Button("Keystrokes", "This function alaways works.", function()
local ScreenGui = Instance.new("ScreenGui")
...
coroutine.wrap(FPWA_fake_script)()
 Flux:Notification("Credit to ComoEsteban.", "Thanks")
end)
tab2:Button("Infinite Jump", "This function alaways works.", function()
--[[
...
tab2:Button("Spider", "This function alaways works.", function()
...
tab2:Button("Phase", "This function alaways works.", function()
